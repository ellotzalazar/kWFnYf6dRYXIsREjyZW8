			...
			<div class="row">
				<div class="span12">
					...
					<div class="container">
						...
						<li class="active"><a rel="tooltip"  data-placement="bottom" title="Contact Us" id="contactus" href="Portfolio.php" class=""><i class="icon-film icon-large"></i>&nbsp;Portfolio</a></li>
						</ul>
				...
				</div><div> <?php include('footer.php') ?></div>
				</div>
			</div>
