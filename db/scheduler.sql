...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2018 at 07:39 AM
...
INSERT INTO `members` (`member_id`, `firstname`, `lastname`, `middlename`, `address`, `email`, `contact_no`, `birthdate`, `gender`, `username`, `password`, `status`) VALUES
...
INSERT INTO `schedule` (`id`, `member_id`, `date`, `service_id`, `package_id`, `hours`, `location`, `venue`, `sched_time`, `total_price`, `Number`, `status`) VALUES
...
--
ALTER TABLE `images`
  ADD PRIMARY KEY (`image_id`), ADD KEY `member_id` (`member_id`);
...
--
ALTER TABLE `package`
  ADD PRIMARY KEY (`package_id`), ADD KEY `service_id` (`service_id`);

--
-- Indexes for table `photostatus`
--
ALTER TABLE `photostatus`
...
--
-- AUTO_INCREMENT for table `photostatus`
--
ALTER TABLE `photostatus`
