...
$uploader->allowedExtensions = array('jpg','png','gif','jpeg','mp4'); // all files types allowed by default
...
if ($method == "POST") {
    ...
    if (isset($_GET["done"])) {
        $result = $uploader->combineChunks("../../portfolio");
    }
    // Handles upload requests
    else {
        // Call handleUpload() with the name of the folder, relative to PHP's getcwd()
        $result = $uploader->handleUpload("../../portfolio");
...
// for delete file requests
    ...
    $result = $uploader->handleDelete("../../portfolio");
    echo json_encode($result);
}
else {
