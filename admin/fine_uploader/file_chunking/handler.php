...
class UploadHandler {
    ...
    public function getInitialFiles() {
        ...
        for ($i = 0; $i < 5000; $i++) {
            array_push($initialFiles, array("name" => "name" + $i, uuid => "uuid" + $i, thumbnailUrl => "file_chunking/fu.png"));
        }
    ...
    public function combineChunks($uploadDirectory, $name = null) {
        ...
        $targetPath = join(DIRECTORY_SEPARATOR, array($uploadDirectory, 'video', $name));
