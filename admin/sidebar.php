		...
		Time is: &nbsp;<input type="submit" class="trans" name="face" value="">
						...
						<div class="navbar">
								...
								<ul class="nav nav-tabs nav-stacked">
									...
									<li><a href="service.php"><i class="icon-briefcase	icon-large"></i>&nbsp;Services<i class="icon-arrow-right icon-large"></i></a></li>
									<li><a href="package.php"><i class="icon-briefcase	icon-large"></i>&nbsp;Packages<i class="icon-arrow-right icon-large"></i></a></li>
									...
									<li><a href="note.php"><i class="icon-file icon-large"></i>&nbsp; Bulletin<i class="icon-arrow-right icon-large"></i></a></li>
									<li><a href="upload_files.php"><i class="icon-file icon-large"></i>&nbsp; Upload Files<i class="icon-arrow-right icon-large"></i></a></li>
									<li><a href="upload_portfolio.php"><i class="icon-file icon-large"></i>&nbsp; Portfolio<i class="icon-arrow-right icon-large"></i></a></li>
								</ul>
							</div>
